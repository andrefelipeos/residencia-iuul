...
turma.lancarNota(aluno1.matricula, "p2", 8.0);
turma.lancarNota(aluno2.matricula, "p1", 8.0);
turma.lancarNota(aluno2.matricula, "p2", 8.0);
turma.lancarNota(aluno3.matricula, "p1", 8.0);
turma.lancarNota(aluno3.matricula, "p2", 8.0);
turma.lancarNota(aluno4.matricula, "p1", 8.0);
turma.lancarNota(aluno4.matricula, "p2", 8.0);
turma.imprimir();
